 ...
 * @author nguye
 */
@WebServlet(name = "ChangePageManagerServlet", urlPatterns = {"/ChangePageManagerServlet"})
public class ChangePageManagerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            proDAO.getAllProductByIndex(pa);
            ...
            url = "managerCourse.jsp?index=" + page;
