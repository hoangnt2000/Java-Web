 ...
 * @author nguye
 */
@WebServlet(name = "DeteleCartServlet", urlPatterns = {"/DeteleCartServlet"})
public class DeteleCartServlet extends HttpServlet {
   ...
   private final String VIEW_CART_PAGE ="viewCart.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String type = request.getParameter("typeRemove");
