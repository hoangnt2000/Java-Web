<%-- 
    Document   : editPage
    Created on : Sep 19, 2021, 4:10:11 PM
    Author     : nguye
--%>
    ...
    <body>
        ...
        <c:if test="${not empty sessionScope.NAME}">
            ...
            <div class="container" style="margin: 0px 200px; padding: 0px; ">
                <a class="navbar-brand" href="DispatchServlet">Musicc Shop</a>
                ...
                <c:if test="${not empty PROLIST}">
                    <c:set var="proDTO" value="${PROLIST}"/>
                            ...
                            <div class="row" style="margin-right: 500px; width: 900px;">
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        <Strong>UserID Updated: </Strong>  
                                        <input style="width: 350px;" value="${proDTO.userID}" name=""  type="text" id="inputEmail" class="form-control" readonly>
                                        <input value="${sessionScope.AccDTO.ID}" name="txtUserID" type="hidden"/>
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        <Strong>Last Date Update: </Strong> 
                                        <input style="width: 350px;" value="${proDTO.updateDate}" name=""  type="text" id="inputEmail" class="form-control" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-right: 500px; width: 900px;">
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <input style="width: 350px;" value="${proDTO.proID}" name="txtID"  type="text" id="inputEmail" class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        <Strong>Product Name: </Strong> 
                                        <input style="width: 350px;" value="${proDTO.proName}" name="txtName"  type="text" id="inputEmail" class="form-control" autofocus="" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-right: 500px; width: 900px;">
                                    ...
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <select name="txtSupName" style="width: 350px;">
                                            <c:forEach var="sdto" items="${supDTO}">
                                                <option 
                                                    <c:if test="${proDTO.supID == sdto.supID}">selected</c:if>
                                                >
                                                 ${sdto.companyName}   
                                                </option>
                                            </c:forEach>
                                    ...
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <select name="txtCateName" style="width: 350px;">
                                            <c:forEach var="cdto" items="${cateDTO}">
                                                <option 
                                                    <c:if test="${proDTO.cateID == cdto.cateID}">selected</c:if>
                                                >
                                                 ${cdto.cateName}   
                                                </option>
                                            </c:forEach>
                            ...
                            <div class="row" style="margin-right: 500px; width: 900px;">
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <input style="width: 350px;" value="${proDTO.quantity}" name="txtQuantity"  type="text" id="inputEmail" class="form-control" required pattern="[0-9]+">
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        <Strong>Unit Price: </Strong>
                                        <input style="width: 350px;" value="${proDTO.price}" name="txtPrice"  type="text" id="inputEmail" class="form-control" required pattern="[0-9]+">
                                    </div>
                                </div>
                            </div> 
                            <div class="row" style="margin-right: 500px; width: 900px;">
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <input style="width: 350px;" value="${proDTO.image}" name="txtImage"  type="text" id="inputEmail" class="form-control" required>
                                    </div>
                                </div>
                                    <div class="col-sm-6" style="padding-top: 27px;"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        <div class="form-group">
                                            <input type="file" class="form-control-file border" name="file" style="width: 350px;" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <select name="txtStatus" >
                                            <option <c:if test="${proDTO.status == true}">selected=""</c:if>>Avaliable</option>
                                            <option <c:if test="${proDTO.status != true}">selected="" </c:if>>Sold Out</option>
                                        </select></br>    
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <select name="txtDelete" >
                                            <option <c:if test="${proDTO.isDelete == true}">selected=""</c:if>>Yes</option>
                                            <option <c:if test="${proDTO.isDelete != true}">selected="" </c:if>>No</option>
                                        </select></br> 
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-right: 500px; width: 900px;">
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        ...
                                        <input type="date" class="form-control" width="276" value="${proDTO.startDate}" name="txtStart" required>
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                        <Strong class="control-label" for="datepicker-end">End Date</Strong>
                                         <input type="date" class="form-control" width="276" value="${proDTO.endDate}" name="txtEnd" required>
                                    </div>
                                </div>
                            </div>
                        <input type="hidden" value="${INDEX}" name="index">
                        <button type="summit" class="btn btn-primary" name="btAction" value="Update" style=" width: 70px;height: 40px;margin-bottom: 5px;margin-left: 750px;">Edit</button>
                        </div>
